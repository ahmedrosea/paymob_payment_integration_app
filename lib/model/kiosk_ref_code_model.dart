class KioskRefCodeModel {
  ...
  factory KioskRefCodeModel.fromJson(Map<String, dynamic> json) =>
      KioskRefCodeModel(
        id: json["id"],
        ...
        data: KioskRefCodeModelData.fromJson(json["data"]),
...
class KioskRefCodeModelData {
  KioskRefCodeModelData({
  ...
  factory KioskRefCodeModelData.fromJson(Map<String, dynamic> json) =>
      KioskRefCodeModelData(
